  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="h-[calc(100vh-var(--nav-height,80px))] flex flex-col justify-between relative gap-8 pb-8">
              ...
              <div className="flex justify-between grow">
                <motion.button
                  ...
                  className="hidden md:flex items-center gap-2 text-foreground hover:text-foreground transition-colors grow self-end basis-1"
                >
                  <div className="text-xl">Explore</div>
                  <ArrowDown className="h-5 w-5" />
                </motion.button>

                <div className="grow flex self-end leading-[.8em] font-semibold text-4xl md:text-[80px] basis-1">
        ...
        <section>
          <Container>
            <div className="grid md:grid-cols-2 gap-4 border-t my-12 py-4">
              <div>About</div>
              <div className="flex flex-col gap-4 max-w-[55ch]">
                ...
                <p>He typically engages as a fractional product designer, helping startups establish their brand strategy, build their brand identity, craft delightful products, and then define, measure, and improve on key success indicators. </p>
          ...
          <Container>
            <div className="grid md:grid-cols-2 gap-4 border-t my-12 py-4">
              ...
              <div className="flex flex-col gap-4 max-w-[60ch]">
                  <div className="flex flex-col font-bold text-4xl md:text-[48px] gap-2 lg:-space-y-3">
